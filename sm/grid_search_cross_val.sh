...
supervision="sup"
logs="cross_val/cross_val_"${dataset}"_90_40_"${supervision}
mkdir -p $logs
...
do
	...
	do
		...
		echo "/home/cse/btech/cs1150210/anaconda3/bin/python3 cross_validation.py --folds ${folds} --dir ${dir} --labelled_training_data_path $labelled_training_data_path --unlabelled_training_data_path ${unlabelled_training_data_path} --num_epochs 20 --config $yml --batch_size 2048 --num_templates 5 --each_input_size 7 --supervision ${supervision} &" >> $sh
